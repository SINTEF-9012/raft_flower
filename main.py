...
if __name__ == '__main__':
    ...
    while True:    
        ...
        if sync_obj._isLeader():            
            ...
            # Define strategy
            strategy = RaftStrategy(initial_parameters=initial_parameters, evaluate_metrics_aggregation_fn=weighted_average, replicated_state=replicated_state, sync_obj=sync_obj, min_fit_clients=2, min_evaluate_clients=2, min_available_clients=2)
