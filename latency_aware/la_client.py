...
class FlowerClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        #    print(selfAddr +" fit_parameter_" + str(i), objsize.get_deep_size(param))
        #    self.replicated_state.set(selfAddr + "_fit_parameter_" + str(i), param, sync=True)
        #    i = i + 1
        #print("initialize_parameters_tensor_type", parameters.tensor_type)        
        #self.replicated_state.set("initialize_parameters_tensor_type", parameters.tensor_type, sync=True)
        #print(selfAddr + "_fit_parameter_length", len(parameters))
        #self.replicated_state.set(selfAddr + "_fit_parameter_length", len(parameters), sync=True)
...
if __name__ == '__main__':
    ...
    fl.client.start_numpy_client(server_address='172.17.192.1' + ":8080", client=FlowerClient(replicated_state=replicated_state, nodes=partners))
